...
public class KeyboardView extends View implements View.OnClickListener {
    ...
    public KeyboardView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a =
            context.obtainStyledAttributes(attrs, R.styleable.KeyboardView, defStyleAttr, 0);
    ...
    public void setLabelTextSize(@Dimension int pixel) {
    ...
    public void setKeyTextColorRes(@ColorRes int colorRes) {
        mKeyTextColor = ContextCompat.getColor(getContext(), colorRes);
    }
    ...
    private void onBufferDraw() {
        if (mBuffer == null || mKeyboardChanged) {
            if (mBuffer == null || mKeyboardChanged && (mBuffer.getWidth() != getWidth()
    ...
    private int getKeyIndices(int x, int y, int[] allKeys) {
        ...
        for (int i = 0; i < keyCount; i++) {
            ...
            if (((mProximityCorrectOn
                && (dist = key.squaredDistanceFrom(x, y)) < mProximityThreshold) || isInside)
                && key.codes[0] > 32) {
    ...
    protected boolean onLongPress(Key popupKey) {
        ...
        if (popupKeyboardId != 0) {
            ...
            if (mMiniKeyboardContainer == null) {
                ...
                mMiniKeyboard =
                    (KeyboardView) mMiniKeyboardContainer.findViewById(R.id.keyboardView);
                ...
                if (popupKey.popupCharacters != null) {
                    keyboard =
                        new Keyboard(getContext(), popupKeyboardId, popupKey.popupCharacters, -1,
    ...
    public boolean onTouchEvent(MotionEvent me) {
        ...
        if (pointerCount != mOldPointerCount) {
            if (pointerCount == 1) {
                ...
                MotionEvent down =
                    MotionEvent.obtain(now, now, MotionEvent.ACTION_DOWN, me.getX(), me.getY(),
                        me.getMetaState());
                ...
                MotionEvent up =
                    MotionEvent.obtain(now, now, MotionEvent.ACTION_UP, mOldPointerX, mOldPointerY,
                        me.getMetaState());
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                ...
                mKeyboardActionListener.onPress(
                    keyIndex != NOT_A_KEY ? mKeys[keyIndex].codes[0] : 0);
